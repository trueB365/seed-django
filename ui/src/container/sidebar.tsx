...
const SideBar = ({ children, ...otherProps }: any) => {
   ...
   return  (<>
        <div className='flex  md:flex-row w-screen fixed text-white' {...otherProps}>
            <div
              className='hidden md:flex basis-0 md:basis-[4%] justify-center w-16 h-screen border-r border-r-main-white-lighter text-main-white'>
                <div className='mt-[2em] list-none text-white'>
                    <a className='text-main-white-lighter mb-[1.8em]' href='#'>
            ...
            <div className='relative basis-[100%] w-sreen h-screen'>
                <Navigation />
                <div className='absolute z-0 container mx-auto overflow-scroll h-screen hidden-scrollbar'>
                    {children}
                </div>
