...
class Pronhub:
    ...
    def get_video_info(self, url):
        ...
        for ele in tree.xpath("//li/div[@class ='wrap']"):
            try:
                ...
                item["video_quality"] = int(
                    ele.xpath(".//div[@class ='value']/text()")[0]
                    .replace("%", "")
                    .strip()
                )
    ...
    def insert_video(self, search, page):
        goal_url = "https://www.pornhub.com/video/search?search={}&page={}".format(
            search, page
        )
...
# docker run -d --rm -e ALLOW_EMPTY_PASSWORD=yes -v ~/Docker/redis/redis-persistence:/bitnami/redis/data -p 6379:6379 --name redis bitnami/redis:latest
